...
// interval) sends statstics about backpressure experienced on the
...
func SendClientStatistics(cl *Client, stats *statsd.Client, tags []string) {
	stats.Count("trace_client.flushes_failed", atomic.SwapInt64(&cl.failedFlushes, 0), tags, 1.0)
	stats.Count("trace_client.flushes_succeeded", atomic.SwapInt64(&cl.successfulFlushes, 0), tags, 1.0)
	stats.Count("trace_client.records_failed", atomic.SwapInt64(&cl.failedRecords, 0), tags, 1.0)
	stats.Count("trace_client.records_succeeded", atomic.SwapInt64(&cl.successfulRecords, 0), tags, 1.0)
}
